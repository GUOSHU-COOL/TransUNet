...
#             'list_dir': './lists/lists_Synapse', #log
#             'num_classes': 2,
#             'z_spacing': 1,
#         },
#     }
...
parser.add_argument('--max_iterations', type=int,default=30, help='maximum epoch number to train')
parser.add_argument('--max_epochs', type=int, default=3, help='maximum epoch number to train')
parser.add_argument('--batch_size', type=int, default=24,
                    help='batch_size per gpu')
parser.add_argument('--img_size', type=int, default=224, help='input patch size of network input')
